...
trait Stream[+A] {
  ...
  def takeWhile2(p: A => Boolean): Stream[A] =
    foldRight[Stream[A]](empty)((a, s) => if(p(a)) cons(a, s) else empty)
  ...
  def zipWithUnfold[B,C](b: Stream[B])(f: (A,B) => C): Stream[C] = {
    unfold((this, b))({
...
object Stream {
  ...
  def fibs2: Stream[Int] = {
    unfold((0, 1))(x => Some((x._1, (x._2, x._2 + x._1))))
  }
